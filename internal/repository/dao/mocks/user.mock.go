...
//
//	mockgen.exe -source=./internal/repository/dao/user.go -package=daomocks -destination=./internal/repository/dao/mocks/user.mock.go
//
...
// InsertInfo mocks base method.
func (m *MockUserDAO) InsertInfo(ctx context.Context, u dao.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InsertInfo", ctx, u)
	ret0, _ := ret[0].(error)
	return ret0
}

// InsertInfo indicates an expected call of InsertInfo.
func (mr *MockUserDAOMockRecorder) InsertInfo(ctx, u any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InsertInfo", reflect.TypeOf((*MockUserDAO)(nil).InsertInfo), ctx, u)
}
